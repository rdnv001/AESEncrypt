...
\begin{DoxyCompactList}\small\item\em Главная функция программы. Разбирает аргументы командной строки и запускает процесс шифрования/дешифрования. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Главная функция программы. Разбирает аргументы командной строки и запускает процесс шифрования/дешифрования. 
