...
/**
 * @brief Основная функция программы для шифрования и дешифрования файлов с использованием AES-256.
 *
 * Функция принимает аргументы командной строки для выбора режима работы (шифрование или дешифрование), 
 * а также для указания входного и выходного файлов, и пароля для генерации ключа.
 *
 ...
 *   - `-p` пароль для генерации ключа.
 * 
 * @return Код завершения программы.
 *   - `0` если операция завершена успешно.
 *   - `1` если произошла ошибка в аргументах или процессе выполнения.
 */
